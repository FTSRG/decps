...
/**
 * A match processor tailored for the hu.bme.mit.inf.cps.patterns.allocate pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class AllocateProcessor implements IMatchProcessor<AllocateMatch> {
  /**
  ...
  @Override
  public void process(final AllocateMatch match) {
