...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.cps.patterns.deleteAllocation pattern,
 * to be used in conjunction with {@link DeleteAllocationMatcher}.
 * 
...
public abstract class DeleteAllocationMatch extends BasePatternMatch {
  ...
  private DeleteAllocationMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
  ...
  public List<String> parameterNames() {
    return DeleteAllocationMatch.parameterNames;
  }
  ...
  @Override
  public DeleteAllocationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof DeleteAllocationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    DeleteAllocationMatch other = (DeleteAllocationMatch) obj;
  ...
  @Override
  public DeleteAllocationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DeleteAllocationMatch newEmptyMatch() {
   ...
   * 
   */
  public static DeleteAllocationMatch newMutableMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * 
   */
  public static DeleteAllocationMatch newMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
    return new Immutable(pAppInstance, pHostInstance, pReq);
  }
  
  private static final class Mutable extends DeleteAllocationMatch {
  ...
  private static final class Immutable extends DeleteAllocationMatch {
