...
public abstract class AllApplicationInstanceIsRunningMatch extends BasePatternMatch {
  ...
  private AllApplicationInstanceIsRunningMatch() {
   ...
   * 
   */
  public static AllApplicationInstanceIsRunningMatch newMutableMatch() {
    return new Mutable();
  }
   ...
   * 
   */
  public static AllApplicationInstanceIsRunningMatch newMatch() {
