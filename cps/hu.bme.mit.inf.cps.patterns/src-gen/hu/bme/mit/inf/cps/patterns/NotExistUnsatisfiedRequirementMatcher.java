...
public class NotExistUnsatisfiedRequirementMatcher extends BaseMatcher<NotExistUnsatisfiedRequirementMatch> {
   ...
   * @return matches represented as a NotExistUnsatisfiedRequirementMatch object.
   * 
   */
  public Collection<NotExistUnsatisfiedRequirementMatch> getAllMatches(final Integer pX) {
   ...
   * @param pX the fixed value of pattern parameter x, or null if not bound.
   * @return a match represented as a NotExistUnsatisfiedRequirementMatch object, or null if no match is found.
   * 
   */
  public NotExistUnsatisfiedRequirementMatch getOneArbitraryMatch(final Integer pX) {
   ...
   * 
   */
  public void forEachMatch(final Integer pX, final IMatchProcessor<? super NotExistUnsatisfiedRequirementMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Integer pX, final IMatchProcessor<? super NotExistUnsatisfiedRequirementMatch> processor) {
   ...
   * 
   */
  public NotExistUnsatisfiedRequirementMatch newMatch(final Integer pX) {
    return NotExistUnsatisfiedRequirementMatch.newMatch(pX);
  }
  ...
  protected NotExistUnsatisfiedRequirementMatch tupleToMatch(final Tuple t) {
    try {
    	return NotExistUnsatisfiedRequirementMatch.newMatch((java.lang.Integer) t.get(POSITION_X));
  ...
  protected NotExistUnsatisfiedRequirementMatch arrayToMatch(final Object[] match) {
    try {
    	return NotExistUnsatisfiedRequirementMatch.newMatch((java.lang.Integer) match[POSITION_X]);
    } catch(ClassCastException e) {
  ...
  protected NotExistUnsatisfiedRequirementMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return NotExistUnsatisfiedRequirementMatch.newMutableMatch((java.lang.Integer) match[POSITION_X]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
