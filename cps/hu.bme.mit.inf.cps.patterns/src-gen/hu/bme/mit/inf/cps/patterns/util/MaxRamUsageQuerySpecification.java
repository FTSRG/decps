...
/**
 * A pattern-specific query specification that can instantiate MaxRamUsageMatcher in a type-safe way.
 * 
 * @see MaxRamUsageMatcher
 * @see MaxRamUsageMatch
 * 
 */
@SuppressWarnings("all")
final class MaxRamUsageQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  private MaxRamUsageQuerySpecification() {
   ...
   * 
   */
  public static MaxRamUsageQuerySpecification instance() throws IncQueryException {
    try{
  ...
  private static class LazyHolder {
    private final static MaxRamUsageQuerySpecification INSTANCE = make();
    
    public static MaxRamUsageQuerySpecification make() {
      return new MaxRamUsageQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MaxRamUsageQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.cps.patterns.maxRamUsage";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      new ExpressionEvaluation(body, new IExpressionEvaluator() {
      	...
      	public String getShortDescription() {
      		return "Expression evaluation from pattern maxRamUsage";
      	}
      
      	@Override
      	public Iterable<String> getInputParameterNames() {
      		return Arrays.asList("ram");
      	}
      
      	@Override
      	public Object evaluateExpression(IValueProvider provider) throws Exception {
      			java.lang.Integer ram = (java.lang.Integer) provider.getValue("ram");
      			return evaluateExpression_1_1(ram);
      		}
  ...
  private static boolean evaluateExpression_1_1(final Integer ram) {
    return ((ram).intValue() < 1);
  }
}
