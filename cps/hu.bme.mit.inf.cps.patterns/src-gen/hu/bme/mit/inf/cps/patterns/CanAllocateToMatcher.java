...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.cps.patterns.canAllocateTo pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link CanAllocateToMatch}.
 * 
 * <p>Original source:
 * <code><pre>
...
public class CanAllocateToMatcher extends BaseMatcher<CanAllocateToMatch> {
   ...
   * 
   */
  public static CanAllocateToMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    CanAllocateToMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new CanAllocateToMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(CanAllocateToMatcher.class);
   ...
   */
  @Deprecated
  public CanAllocateToMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public CanAllocateToMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a CanAllocateToMatch object.
   * 
   */
  public Collection<CanAllocateToMatch> getAllMatches(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * @param pHostInstance the fixed value of pattern parameter hostInstance, or null if not bound.
   * @param pReq the fixed value of pattern parameter req, or null if not bound.
   * @return a match represented as a CanAllocateToMatch object, or null if no match is found.
   * 
   */
  public CanAllocateToMatch getOneArbitraryMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * 
   */
  public void forEachMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq, final IMatchProcessor<? super CanAllocateToMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq, final IMatchProcessor<? super CanAllocateToMatch> processor) {
   ...
   * 
   */
  public CanAllocateToMatch newMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
    return CanAllocateToMatch.newMatch(pAppInstance, pHostInstance, pReq);
  }
   ...
   * 
   */
  public Set<ApplicationInstance> getAllValuesOfappInstance(final CanAllocateToMatch partialMatch) {
   ...
   * 
   */
  public Set<HostInstance> getAllValuesOfhostInstance(final CanAllocateToMatch partialMatch) {
   ...
   * 
   */
  public Set<ResourceRequirement> getAllValuesOfreq(final CanAllocateToMatch partialMatch) {
  ...
  @Override
  protected CanAllocateToMatch tupleToMatch(final Tuple t) {
    try {
    	return CanAllocateToMatch.newMatch((hu.bme.mit.inf.cps.ApplicationInstance) t.get(POSITION_APPINSTANCE), (hu.bme.mit.inf.cps.HostInstance) t.get(POSITION_HOSTINSTANCE), (hu.bme.mit.inf.cps.ResourceRequirement) t.get(POSITION_REQ));
  ...
  @Override
  protected CanAllocateToMatch arrayToMatch(final Object[] match) {
    try {
    	return CanAllocateToMatch.newMatch((hu.bme.mit.inf.cps.ApplicationInstance) match[POSITION_APPINSTANCE], (hu.bme.mit.inf.cps.HostInstance) match[POSITION_HOSTINSTANCE], (hu.bme.mit.inf.cps.ResourceRequirement) match[POSITION_REQ]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected CanAllocateToMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return CanAllocateToMatch.newMutableMatch((hu.bme.mit.inf.cps.ApplicationInstance) match[POSITION_APPINSTANCE], (hu.bme.mit.inf.cps.HostInstance) match[POSITION_HOSTINSTANCE], (hu.bme.mit.inf.cps.ResourceRequirement) match[POSITION_REQ]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<CanAllocateToMatcher> querySpecification() throws IncQueryException {
