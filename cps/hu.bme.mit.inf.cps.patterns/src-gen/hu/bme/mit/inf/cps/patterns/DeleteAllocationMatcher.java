...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.cps.patterns.deleteAllocation pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DeleteAllocationMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see DeleteAllocationProcessor
 * @see DeleteAllocationQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DeleteAllocationMatcher extends BaseMatcher<DeleteAllocationMatch> {
  /**
   ...
   * 
   */
  public static DeleteAllocationMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    DeleteAllocationMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new DeleteAllocationMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(DeleteAllocationMatcher.class);
   ...
   */
  @Deprecated
  public DeleteAllocationMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public DeleteAllocationMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a DeleteAllocationMatch object.
   * 
   */
  public Collection<DeleteAllocationMatch> getAllMatches(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * @param pHostInstance the fixed value of pattern parameter hostInstance, or null if not bound.
   * @param pReq the fixed value of pattern parameter req, or null if not bound.
   * @return a match represented as a DeleteAllocationMatch object, or null if no match is found.
   * 
   */
  public DeleteAllocationMatch getOneArbitraryMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * 
   */
  public void forEachMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq, final IMatchProcessor<? super DeleteAllocationMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq, final IMatchProcessor<? super DeleteAllocationMatch> processor) {
   ...
   * 
   */
  public DeleteAllocationMatch newMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
    return DeleteAllocationMatch.newMatch(pAppInstance, pHostInstance, pReq);
  }
   ...
   * 
   */
  public Set<ApplicationInstance> getAllValuesOfappInstance(final DeleteAllocationMatch partialMatch) {
   ...
   * 
   */
  public Set<HostInstance> getAllValuesOfhostInstance(final DeleteAllocationMatch partialMatch) {
   ...
   * 
   */
  public Set<ResourceRequirement> getAllValuesOfreq(final DeleteAllocationMatch partialMatch) {
  ...
  @Override
  protected DeleteAllocationMatch tupleToMatch(final Tuple t) {
    try {
    	return DeleteAllocationMatch.newMatch((hu.bme.mit.inf.cps.ApplicationInstance) t.get(POSITION_APPINSTANCE), (hu.bme.mit.inf.cps.HostInstance) t.get(POSITION_HOSTINSTANCE), (hu.bme.mit.inf.cps.ResourceRequirement) t.get(POSITION_REQ));
  ...
  @Override
  protected DeleteAllocationMatch arrayToMatch(final Object[] match) {
    try {
    	return DeleteAllocationMatch.newMatch((hu.bme.mit.inf.cps.ApplicationInstance) match[POSITION_APPINSTANCE], (hu.bme.mit.inf.cps.HostInstance) match[POSITION_HOSTINSTANCE], (hu.bme.mit.inf.cps.ResourceRequirement) match[POSITION_REQ]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected DeleteAllocationMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return DeleteAllocationMatch.newMutableMatch((hu.bme.mit.inf.cps.ApplicationInstance) match[POSITION_APPINSTANCE], (hu.bme.mit.inf.cps.HostInstance) match[POSITION_HOSTINSTANCE], (hu.bme.mit.inf.cps.ResourceRequirement) match[POSITION_REQ]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<DeleteAllocationMatcher> querySpecification() throws IncQueryException {
