...
/**
 * A match processor tailored for the hu.bme.mit.inf.cps.patterns.canAllocateTo pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CanAllocateToProcessor implements IMatchProcessor<CanAllocateToMatch> {
  /**
  ...
  @Override
  public void process(final CanAllocateToMatch match) {
