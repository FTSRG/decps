...
/**
 * A match processor tailored for the hu.bme.mit.inf.cps.patterns.requirementHasAllApp pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class RequirementHasAllAppProcessor implements IMatchProcessor<RequirementHasAllAppMatch> {
  /**
  ...
  @Override
  public void process(final RequirementHasAllAppMatch match) {
