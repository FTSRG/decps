...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.cps.patterns.allocate pattern,
 * to be used in conjunction with {@link AllocateMatcher}.
 * 
...
public abstract class AllocateMatch extends BasePatternMatch {
  ...
  private AllocateMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
  ...
  public List<String> parameterNames() {
    return AllocateMatch.parameterNames;
  }
  ...
  @Override
  public AllocateMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AllocateMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    AllocateMatch other = (AllocateMatch) obj;
  ...
  @Override
  public AllocateQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static AllocateMatch newEmptyMatch() {
   ...
   * 
   */
  public static AllocateMatch newMutableMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
   ...
   * 
   */
  public static AllocateMatch newMatch(final ApplicationInstance pAppInstance, final HostInstance pHostInstance, final ResourceRequirement pReq) {
    return new Immutable(pAppInstance, pHostInstance, pReq);
  }
  
  private static final class Mutable extends AllocateMatch {
  ...
  private static final class Immutable extends AllocateMatch {
