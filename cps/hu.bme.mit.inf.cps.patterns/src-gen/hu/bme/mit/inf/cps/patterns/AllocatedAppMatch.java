...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.cps.patterns.allocatedApp pattern,
 * to be used in conjunction with {@link AllocatedAppMatcher}.
 * 
...
public abstract class AllocatedAppMatch extends BasePatternMatch {
  ...
  private AllocatedAppMatch(final ApplicationInstance pApp, final ResourceRequirement pRr) {
    this.fApp = pApp;
    this.fRr = pRr;
  }
  ...
  public List<String> parameterNames() {
    return AllocatedAppMatch.parameterNames;
  }
  ...
  @Override
  public AllocatedAppMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AllocatedAppMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    AllocatedAppMatch other = (AllocatedAppMatch) obj;
  ...
  @Override
  public AllocatedAppQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static AllocatedAppMatch newEmptyMatch() {
   ...
   * 
   */
  public static AllocatedAppMatch newMutableMatch(final ApplicationInstance pApp, final ResourceRequirement pRr) {
   ...
   * 
   */
  public static AllocatedAppMatch newMatch(final ApplicationInstance pApp, final ResourceRequirement pRr) {
    return new Immutable(pApp, pRr);
  }
  
  private static final class Mutable extends AllocatedAppMatch {
  ...
  private static final class Immutable extends AllocatedAppMatch {
